...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::sanitize_title(&title);
        Ticket::sanitize_description(&description);
        Ticket::sanitize_status(&status);
    ...
    // If the function does not take self, it is a static function
    fn sanitize_title(title: &String) {
        if title.is_empty() {
    ...
    fn sanitize_description(description: &String) {
    ...
    fn sanitize_status(status: &String) {
